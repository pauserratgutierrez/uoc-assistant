...
export class DBService {
  ...
  constructor(config) {
    if (DBService.#instance) throw new Error('Use DBService.getInstance() to get instance.')
  ...
  static getInstance(config = null) {
    if (!DBService.#instance && config) DBService.#instance = new DBService(config)
    if (!DBService.#instance) throw new Error('DB service not initialized. Provide config.')
